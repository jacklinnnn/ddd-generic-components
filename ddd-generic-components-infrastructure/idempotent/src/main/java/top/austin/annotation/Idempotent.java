package top.austin.annotation;

import top.austin.enums.IdempotentSceneEnum;
import top.austin.enums.IdempotentTypeEnum;
...
public @interface Idempotent {
    ...
    /**
     * 设置防重令牌Key前缀，MQ幂等去重可选设置
     * {@link IdempotentSceneEnum#MQ_MESSAGE} and {@link IdempotentTypeEnum#SPEL} 时生效
     */
